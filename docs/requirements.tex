...
\section{Changelog}
Changes to this document will be recorded here. Full details can be viewed in the \href{https://github.com/TripleParity/docks}{Docks} Repository.

\subsection*{2018-05-08}

\subsubsection*{Added}
\begin{itemize}
	\item Entity Relationship Diagram for Docks API Database
	\item Permissions are now part of account Roles
\end{itemize}

\subsubsection*{Changed}
\begin{itemize}
	\item Some terms involving docker Containers
\end{itemize}

\subsubsection*{Fixed}
\begin{itemize}
	\item N-Tier should be 3-Tier
\end{itemize}

\pagebreak

\subsection*{2018-04-13}
Initial release.
